...
export const Discover: React.FC = () => {
    ...
    const [getRandomRecipes, { loading, data: oldData }] = useLazyQuery(gql`
                ...
                <Col>
                    <InputGroup className="mb-3">
                        ...
                        loading ?
                            ...
                            <DiscoveryResults recipes={data && data.randomRecipes ? data.randomRecipes as any : null} hasSearched={hasSearched} />
                    }
                </Col>
            </Row>
        </Container>
